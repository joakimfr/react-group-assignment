...
import aboutimage from '../assets/eva-cortado.jpg'
    ...
    <section className="about">
        ...
        <section className="about__wrapper">
            ...
            <section className="about__text">
              <p className="about__text__bold"> Pumpkin spice mug, barista cup, sit macchiato, kopi-luwak, doppio, grounds dripper, crema, strong whipped, variety extra iced id lungo half and half mazagran. Pumpkin spice.</p>
            ...
            <section className="about__founder">
              <img className="about__founder__image" src={aboutimage} alt="" />
              <h3 className="about__founder__name">Eva Cortado</h3>
              <p>VD & grundare</p>
            </section>
